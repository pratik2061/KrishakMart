        ...
        >
          ...
          <div className="flex flex-col h-full">
            <nav className="flex-1 px-4 py-6 space-y-2">
              ...
              {/* <button
                onClick={() => logout()}
                className="flex items-center gap-4 px-4 py-3 rounded-lg text-base font-medium transition-all duration-200 text-red-600 hover:bg-red-50 hover:text-red-700 w-full text-left"
              >
